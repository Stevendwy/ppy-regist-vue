...
.useragreement(@click="hiddenself")
    ...
    .useragreecontent
        ...
        div
            b 《007vin EPC query system user registration protocol.》
        ...
        div
            b   007vin Confirmation and acceptance of service terms.
        ...
        p  Cloud and steam distribution Reserves the right to independently decide on/offline brand, refuse service, close user account, clear or edit content within the scope of law permitted by the mainland of the People's Republic of China.
        
        div
            b   007vin service
        p   007vin The Internet provides users with Internet information and other services through the Internet, and users fully agree with this agreement and the auto industry. In the case of the relevant provisions, the party shall have the right to use the 2000ac Related services.
        ...
        p   007vin It is currently supported in a variety of system environments and is recommended for firefox and Google Chrome.
        p   007vin The data coverage supported by the query is subject to the official announcement.
        p   In order to ensure the auto - trade; The healthy operation of the service environment. System has operation flow analysis and limit rules, on the user's operating frequency has a certain limit rules express, users must register clear recognition and comply with this constraint may register and buy 007vin .
        ...
        p   Users agree that the cloud distribution With the form of email, text message, telephone, etc., to the registered users of this site to send the auto Relevant promotion activities and other information such as the right to inform.
        p   Users agree that the cloud distribution The user shall have the right to use the registration information of the user and the information of the accessory inquiry data, and log in to the user and other registered accounts for evidence preservation, including but not limited to notarization and witness.
        ...
        p   If the user fails to comply with the above provisions, the cloud automobile distribution The right to make independent judgment and to suspend or close user account. Users must use the auto - trade; To undertake the legal liability for the conduct of the inquiry.
